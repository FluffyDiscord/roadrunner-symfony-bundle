...
class WorkflowOutboundCallsInterceptor implements \Temporal\Interceptor\WorkflowOutboundCallsInterceptor
{
    ...
    /**
     * @param callable(AwaitInput): PromiseInterface<mixed> $next
    ...
    /**
     * @param callable(AwaitWithTimeoutInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(CancelExternalWorkflowInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(CompleteInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(ContinueAsNewInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(ExecuteActivityInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(ExecuteChildWorkflowInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(ExecuteLocalActivityInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(GetVersionInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(PanicInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(SignalExternalWorkflowInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(TimerInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(UpsertMemoInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(UpsertSearchAttributesInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
    ...
    /**
     * @param callable(UpsertTypedSearchAttributesInput): PromiseInterface<mixed> $next
     * @return PromiseInterface<mixed>
     */
